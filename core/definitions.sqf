...
QUERY(_countQuery, !([_x] call ace_sys_wounds_fnc_isUncon), _countQuery); \
...
if (isMultiplayer) then { \
	TEAMS set [count TEAMS, [NAME, 0, 0, [], []]]; \
...
["endScreen", [SCENARIO, timeLimit, TEAMS]] call CBA_fnc_globalEvent;
